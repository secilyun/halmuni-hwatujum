(() => {
  ...
  var compareSegments = (a, b) => {
    ...
    for (let i = 0; i < maxLength; i++) {
      const segA = (_a = a[i]) != null ? _a : "0";
      const segB = (_b = b[i]) != null ? _b : "0";
  ...
  var IAP = {
    ...
    createOneTimePurchaseOrder: (params) => {
      ...
      const sku = (_a = options.sku) != null ? _a : options.productId;
    ...
    createSubscriptionPurchaseOrder: (params) => {
      ...
      const unregisterCallbacks = createEventBridge2("requestSubscriptionPurchase")({
        options: { sku, offerId: offerId != null ? offerId : null },
        onEvent: async (event) => {
          if (event.type === "purchased") {
  ...
  var startUpdateLocation2 = (params) => {
    return createEventBridge2("updateLocationEvent")(__spreadProps(__spreadValues({}, params), {
      onError: (error) => {
  ...
  function normalizeAdResponse(adResponse) {
    ...
    return {
      requestId: (_a = adResponse.requestId) != null ? _a : "",
      status: (_b = adResponse.status) != null ? _b : "OK",
      ads,
      ext: adResponse.ext
    };
  }
  function normalizeApiResponse(raw) {
    if (isApiResponse(raw)) {
      ...
      return __spreadProps(__spreadValues({}, raw), { success: normalizeAdResponse(raw.success) });
    }
    if (isAdResponse(raw)) {
      return {
        resultType: "SUCCESS",
  ...
  `;
    const styleContainer = (_b = (_a = documentRef.head) != null ? _a : documentRef.body) != null ? _b : documentRef.documentElement;
    if (!styleContainer) {
      return;
    }
  ...
  function wrapCallbacks(adGroupId, callbacks) {
    ...
    const mapEvent = (payload) => {
      var _a, _b;
      const next = __spreadValues({}, payload != null ? payload : {});
      next.adGroupId = (_b = (_a = next.adGroupId) != null ? _a : next.spaceId) != null ? _b : adGroupId;
      delete next.spaceId;
      return next;
    };
    return {
      ...
      onAdImpression: (payload) => {
        ...
        tossAdEventLog({
          ...
          params: {
            ...
            schema_id: 1812034,
            request_id: (_b = (_a = payload == null ? void 0 : payload.adMetadata) == null ? void 0 : _a.requestId) != null ? _b : ""
          }
        });
        (_c = callbacks.onAdImpression) == null ? void 0 : _c.call(callbacks, mapEvent(payload));
      },
      onAdFailedToRender: (payload) => {
        var _a, _b;
        return (_b = callbacks.onAdFailedToRender) == null ? void 0 : _b.call(callbacks, __spreadProps(__spreadValues({}, mapEvent(payload)), {
          error: (_a = payload == null ? void 0 : payload.error) != null ? _a : { code: 0, message: "UNKNOWN" }
        }));
      },
      onNoFill: (payload) => {
        var _a;
